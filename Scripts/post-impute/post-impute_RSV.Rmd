...
Concatenate separate chromosome files from imputation server back into merged file
...
awk '$10 >= 0.1875 {print $1, $2}'RSV_Oxford_sib | uniq > RSV_Oxford_sib.outliers.txt 
...
plink2 --pfile RSV_Oxford_nosib --pca 
