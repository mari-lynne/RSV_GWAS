...
-   Include first 4/poss 5 PC's as covariates in association analysis
...
-   𝛽 are our model coefficients of determination So, for every SNP we are modelling, whether zero, one or two copies of an allele in our population, forms a linear relationship with our y variable, RSV severity.

![](images/Taipei2015session02_page-0012.jpg)

The null hypthothesis is that there is no linear relationship. Therefore if;\
